...
doc: [HLS streaming server with NGINX on a Ubuntu (Linux) Virtual Machine](https://docs.google.com/document/d/1tX_mrZiXoogILrApajvrsbWbkt3BEla8LAA3CHZl3Po/edit#)
